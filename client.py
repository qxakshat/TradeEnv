...
class TradeEnvClient(
    ...
    def _parse_result(self, payload: Dict) -> StepResult[TradeEnvObservation]:
        ...
        observation = TradeEnvObservation(
            ...
            role=obs_data.get("role", "aggressive_buyer"),
            ...
            best_bid=obs_data.get("best_bid", obs_data.get("current_price", 1.0)),
            best_ask=obs_data.get("best_ask", obs_data.get("current_price", 1.0)),
            spread_bps=obs_data.get("spread_bps", 0.0),
            bid_depth_top=obs_data.get("bid_depth_top", 0.0),
            ...
            pe_ratio=obs_data.get("pe_ratio", 0.0),
            price_to_book=obs_data.get("price_to_book", 0.0),
            return_on_equity=obs_data.get("return_on_equity", 0.0),
            debt_to_equity=obs_data.get("debt_to_equity", 0.0),
            profit_margin=obs_data.get("profit_margin", 0.0),
            revenue_growth=obs_data.get("revenue_growth", 0.0),
            fundamental_quality_score=obs_data.get("fundamental_quality_score", 0.0),
